...
export async function POST(
  ...
  // 🔥 Determine metric type for forecast engine
  const metricType =
    cluster.event_type === "scrap" ? "scrap" : "oee";

  // Default impact contribution (30% of gap)
  const impactPercent = 0.3;
